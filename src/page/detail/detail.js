              ...
              <div class="sm:col-span-3 col-span-0  synopsis">
                ...
                <div className="synopsis">
                  ...
                  <div className="text-sm text-gray-200 text-justify">
                    ...
                    ipsum earum. Vel nostrum rerum quidem reprehenderit veniam earum aliquam eos, est quo necessitatibus odit ratione libero harum unde odio illum, porro voluptates dicta fuga pariatur. Sunt ratione alias enim culpa
                    recusandae molestiae atque doloremque praesentium! Aspernatur quasi repellendus aperiam? Molestias, quos inventore! Eum facilis eos obcaecati voluptates quisquam? Natus, impedit, ipsum a ad animi, porro vitae dignissimos
                    corrupti quisquam qui blanditiis sapiente voluptate id reprehenderit ratione! Enim excepturi ad quas quasi alias?
                  </div>
                </div>
              </div>
            </div>
